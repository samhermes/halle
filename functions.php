 ...
 */
function harper_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'harper' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'harper' ),
...
add_action( 'widgets_init', 'harper_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function harper_scripts() {
	wp_enqueue_style( 'harper-work-sans', 'https://fonts.googleapis.com/css?family=Work+Sans:400,500,600' );
